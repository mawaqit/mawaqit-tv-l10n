...
class MawaqitTvLocalizationsHu extends MawaqitTvLocalizations {
  ...
  String get hadithLangDesc =>
      'Ez felülírja az admin konzolban tett választásodat, a képernyőn más nyelvet választhatsz';
  ...
  String get afterSalahHadith =>
      'Ó, Allah! E tökéletes hívás (da\'wah) és az előírt ima (asz-szalát) Ura, add meg Muhammadnek a waszílah-t (egy különleges hely a Paradicsomban) és a kiválóságot, és emeld őt fel egy dicséretes rangra (a közbenjárás joga), amelyet megígértél neki';
  ...
  String get mosqueNotFoundMessage =>
      'Sajnáljuk, de a mecsetét nem találtuk meg, lehet, hogy hiányzik vagy ideiglenesen le van tiltva.';

  @override
  String get noInternetMessage =>
      'Nincs internet-hozzáférés. Kérjük, ellenőrizd internetkapcsolatodat, és próbáld meg újra. Wi-Fi vagy Ethernet csatlakoztatva van?';
  ...
  String get mosqueErrorMessage =>
      'Mecset hiba: Ha a mecset adminisztrátora vagy, lépj kapcsolatba ügyfélszolgálatunkkal a probléma megoldása érdekében';
  ...
  String get duaaBetweenSalahAndAdhan =>
      'Anasz ibn Málik azt mondta: Azt mondta Allah Küldötte (Allah békéje és áldása legyen vele): Az adhan és az iqama közötti fohászt Allah nem utasítja el.';
  ...
  String get mainScreenOrSecondaryScreenEXPLINATION =>
      'Ezt a képernyőt a főimaterembe (férfi imaterem) szeretnéd telepíteni ?';
  ...
  String get announcementOnlyModeEXPLINATION =>
      'Válaszd ki, hogy a képernyő állandóan megjelenítsen-e közleményeket, ez hasznos lehet akkor, ha például a képernyőt a bejáratnál helyezed el.';

  @override
  String get duaaElEftarText =>
      'Ó, Allah, érted böjtöltem, és a Te ellátmányoddal törtem meg a böjtöt. Hozzád fordulok, és Rád hagyatkozom. Elmúlt a szomjúság, megnedvesedtek az erek, és biztosított a jutalom Allah engedelmével';

  @override
  String get secondaryScreenExplanation =>
      'Egy másodlagos imateremben (például a női teremben vagy egy másik emeleten) ez a képernyő mutatja a pénteki ima élő közvetítését';

  @override
  String get mainScreenExplanation =>
      'Ez a képernyő a mecset főimatermében nem fogja mutatni a pénteki ima élő közvetítését';

  @override
  String get normalModeExplanation =>
      'Az imaidőket és a közleményeket tartalmazó normál képernyőt fogja megjeleníteni.';
  ...
  String get deviceDefaultBTNDescription =>
      'A Mawaqit automatikusan kiválasztja az alapértelmezett tájolást a képernyő tájolása alapján';
  ...
  String get landscapeBTNDescription =>
      'Vízszintes tájolás: a mawaqit tv alkalmazás főelrendezése és a legtöbb mecset számára ajánlott elrendezés';
  ...
  String get takbeerAleidText =>
      'Alláhu Akbar, Alláhu Akbar, Alláhu Akbar, lá iláha illá Alláh, Alláhu Akbar, Alláhu Akbar, wa lilláhil-hamd';
  ...
  String get ifYouAreFacingAnIssueWithTheAppActivateThis =>
      'Ha problémáid vannak az alkalmazással, próbáld meg engedélyezni ezt az opciót\n';
  ...
  String get hijriAdjustmentsDescription =>
      'Állítsd be helyileg a hijri (hidzsri) dátumot az eszközödön. Ez nem fogja befolyásolni az online mecset beállításait';
  ...
  String get automaticUpdateDescription =>
      'Engedélyezd az \"értesítés a frissítésekről\"-t, hogy megkapd a legújabb funkciókat és fejlesztéseket';
  ...
  String get rtspCameraSettingDesc =>
      'Csatlakozz a helyi kamerához, és jelenítsd meg a pénteki ima streamet a TV képernyőjén.';

  @override
  String get rtspCameraSettingScreenDesc =>
      'Ha itt megadsz egy URL-t, akkor a képernyőd automatikusan átvált videostreamingre, amikor elérkezik a pénteki ima ideje.';
  ...
  String get scheduleDesc =>
      'Engedélyezd ezt a funkciót, hogy automatikusan lejátsszon egy szúrát a tervezett időpontokban.';
  ...
  String get duaaBetweenAdhanAndIqamaaTitle =>
      'A kérések (Du\'a) nem kerülnek elutasításra az Adhán és az Iqáma között.';
  ...
  String get replaceAppWorkflowWithCameraStream =>
      'A képernyő automatikusan megjeleníti a kamera streamet, amint a kamera elkezd rögzíteni; ha leáll, a képernyő visszatér az imaidők kijelzéséhez';
