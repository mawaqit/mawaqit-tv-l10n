...
class MawaqitTvLocalizationsBs extends MawaqitTvLocalizations {
  ...
  String get hadithLangDesc =>
      'Ovo poništava vaš izbor u administratorskoj platformi, možete odabrati drugi jezik na ekranu';
  ...
  String get secondaryScreenExplanation =>
      'Za sekundarnu prostoriju (ženska prostorija za namaz ili neki drugi sprat), ovaj ekran će prikazati Džumu-namaz uživo';

  @override
  String get mainScreenExplanation =>
      'Za glavnu prostoriju džamije, ovaj ekran neće prikazivati ​​direktan prijenos Džume namaza';
  ...
  String get hijriAdjustmentsDescription =>
      'Ispravite hidžretski datum na svom uređaju. Ovo neće utjecati na opšte postavke u Mawaqit. net platformi';
  ...
  String get automaticUpdateDescription =>
      'Omogućite primanje obavijesti o ažuriranju kako bi ste dobili najnovije funkcije i poboljšanja';
  ...
  String get replaceAppWorkflowWithCameraStream =>
      'Kada kamera počne sa snimanjem, ekran će automatski prikazivati njen strim; po završetku snimanja, ekran se vraća na prikaz namaskih vremena';
