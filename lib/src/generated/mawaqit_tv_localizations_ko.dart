...
class MawaqitTvLocalizationsKo extends MawaqitTvLocalizations {
  ...
  String get afterSalahHadith =>
      '알라훔마 랍바 하디히드-다와티-탐마티, 와스-살라틸-카-이마티, 아띠 무함마다닐-와실라타 월-파딜라타, 와브아투 마카만 마흐무다 닐라디와 아타후 [오 알라, 이 완전한 부르심(다와)과 정해진 기도(아-살라트)의 루브, 무함마드에게 와실라와 탁월함을 허락하고 당신이 약속한 칭찬할 만한 위치에 그를 올려주소서]라고 기도합니다.';
  ...
  String get azkarList0 =>
      '아스타그피루 알라, 아스타그피루 알라, 아스타그피루 알라 알라훔마 안타 에살람과 광산 에살람, 타바락타 야 달 잘랄리와 이크람 알라훔마 A`inni `알라 디크리카와 추크리카와 후즈니 `아이바다틱.';
  ...
  String get azkarList2 =>
      'بِسْمِ اللَّهِ الرَّحْمٰنِ الرَّحِيمِ قُلْ أَعُوذُ بِرَبِّ النَّاسِ، مَلِكِ النَّاسِ، إِلٰهِ النَّاسِ، مِنْ شَرِّ الْوَسْوَاسِ الْخَنَّاسِ، الَّذِي يُوَسْوِسُ فِي صُدُورِ النَّاسِ، مِنَ الْجِنَّةِ وَالنَّاسِ';
  ...
  String get azkarList4 =>
      'بِسْمِ اللَّهِ الرَّحْمٰنِ الرَّحِيمِ قُلْ هُوَ اللَّهُ أَحَدٌ، اللَّهُ الصَّمَدُ، لَمْ يَلِدْ وَلَمْ يُولَدْ، وَلَمْ يَكُنْ لَّهُ كُفُوًا أَحَدٌ';
  ...
  String get azkarList6 =>
      '라 일라하 일라 알라, 와다후 라 카리카 라, 라후 엘물쿠 와 라후 엘함두, 와하 알라 코울리 체이인 카디르, 알라 훔마 라 마니 아타테, 와라 무티아 아타테, 와라 야네파 우달 디 자디 마이카 엘드 자드.';

  @override
  String get azkarList7 =>
      '알라후마 안타 라비, 라 일라하 일라 안타, 할락타니 와 아나 아부두카, 와 아나 알라 아흐다카 와 와아다카 마 스타따투, 아우드 빅카 민 샤리 마 산아투, 아부우 라카 비니아마티카 알라야, 와 아부우 비단비, 파그피르 리, 파이낰 후 라 야그피루 준루바 일라 안타';

  @override
  String get azkarList8 =>
      '오늘 우리는 아침을 맞이했고, 왕권은 알라의 것입니다. 찬양은 알라께, 알라 외에는 신이 없으며, 오직 그분만이 동반자가 없으십니다. 왕권도 그분의 것이며, 찬양도 그분께, 그분은 모든 것에 능력이 있으십니다. 오늘의 선함과 그 이후의 선함을 구하며, 오늘의 악과 그 이후의 악으로부터 보호를 구합니다. 나태함과 나이 듦의 악에서 보호를 구하며, 불의 형벌과 무덤의 형벌에서도 보호를 구합니다.';

  @override
  String get azkarList9 =>
      '알라후마, 저는 오늘 아침 당신을 증거로 삼고, 당신의 아르쉬의 운반자들과 천사들, 그리고 모든 피조물을 증거로 삼아, 오직 당신만이 알라이며, 신이 없고 당신과 동반자가 없는 유일한 분임을, 그리고 무함마드가 당신의 종이자 사도임을 네 번 증거합니다. [저녁일 경우: \"알라후마 인니 암사이투...\"]';

  @override
  String get azkarList10 =>
      '알라후마, 저의 몸을 건강하게 해주십시오. 알라후마, 저의 청력을 건강하게 해주십시오. 알라후마, 저의 시력을 건강하게 해주십시오. 알라 외에 신이 없습니다. 알라후마, 저는 당신께 불신과 가난에서 보호해주시길 구하며, 무덤의 형벌로부터도 보호해주시길 구합니다. 알라 외에는 신이 없습니다. (세 번 반복)';
  ...
  String get jumuaaHadith =>
      '예언자 ﷺ(알라의 평화와 축복이 그에게 있을 것임)는 \"누구든지 완벽하게 금식을 한 다음 주무아에 가서 듣고 침묵하는 사람은 그 시간부터 다음 주 금요일까지 사흘 동안의 일을 용서받으며 돌을 만지는 사람은 확실히 헛된 일을 한 것이다\"라고 말했습니다.';
