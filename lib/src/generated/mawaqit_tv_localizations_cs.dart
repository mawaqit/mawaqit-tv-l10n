...
class MawaqitTvLocalizationsCs extends MawaqitTvLocalizations {
  MawaqitTvLocalizationsCs([String locale = 'cs']) : super(locale);

  @override
  String get thisIsATestFromIbrahim => 'Toto je test od Ibrahima';
  ...
  @override
  String get appLang => 'Jazyk aplikace';
  ...
  @override
  String get forcePreProduction => 'Předprodukce';

  @override
  String get disableStaging => 'Přechod na výrobu';

  @override
  String get environmentSwitchSuccess => 'Prostředí bylo úspěšně přepnuto';

  @override
  String get environmentSwitchFailed => 'Nepodařilo se přepnout prostředí';
  ...
  @override
  String get changeMosque => 'Změna mešity';
  ...
  @override
  String get missingMosqueId => 'Chybějící MAWAQIT #ID nebo MOSQUE #ID';

  @override
  String mosqueIdIsNotValid(Object mosqueId) {
    return 'Je mi líto, ale $mosqueId není platný průkaz mešity.';
  }

  @override
  String get selectMosqueId => 'Zadejte prosím své ID mešity';

  @override
  String get mawaqitWelcome => 'Vítejte v MAWAQIT';

  @override
  String get mawaqitDesc => 'Assalamu Alaikom a Baraka\'Allah fikom za výběr MAWAQIT, první a #1 Smart Mosque Network na světě, kterou používají miliony muslimů po celém světě ve více než 85 zemích od roku 2016.\n\nPoskytujeme vám nejpokročilejší zobrazení Chytré mešity, které je k dispozici na více zařízeních (mobil, chytré hodinky, televizní obrazovky), aniž bychom shromažďovali nebo sdíleli vaše osobní údaje.\n\nPodpořte prosím tento požehnaný projekt zde : https://donate.mawaqit.net\n\nJsme nezisková organizace a tento projekt je \"Waqf fi\'sabili Alláh\" (Vyhrazený dar).\n\nDíky vašim darům je tento projekt dostupný komukoli a kdekoli, zcela ZDARMA, bez jakýchkoli poplatků, bez REKLAMY a bez měsíčního předplatného.\n\nTento projekt by nebyl možný bez pomoci Alláha, který dal dohromady nadšenou komunitu talentovaných a zapálených dobrovolníků, kteří pracují dnem i nocí, aby vám poskytli co nejlepší služby a nejmodernější systém dostupný 24 hodin denně, 7 dní v týdnu.\n\nZvažte prosím možnost přispět na udržení tohoto požehnaného projektu v chodu. Baraka\'Allah fikom za vaši trvalou důvěru a podporu.';
  ...
  @override
  String get installationGuide => 'Průvodce instalací';

  @override
  String get drawerTitle => 'MAWAQIT';

  @override
  String get drawerDesc => 'Spojení muslimů s mešitami';

  @override
  String get backendError => 'Omlouváme se, ale nepodařilo se nám připojit k serveru.\nOvěřte prosím připojení k internetu nebo to zkuste později.';

  @override
  String get selectWithMosqueId => 'Vyzkoušejte: 256, je to ID \'Grande Mosquée de Paris\'';

  @override
  String get searchForMosque => 'Kterou mešitu hledáte ? (ID, název, město, poštovní směrovací číslo...)';

  @override
  String get searchMosque => 'Hledání mešity';

  @override
  String get mosqueNameError => 'Zadejte název mešity';

  @override
  String get slugError => 'Není platná mešita slimák';

  @override
  String get doYouKnowMosqueId => 'Znáte své ID zařízení nebo ID mešity?';
  ...
  @override
  String get networkStatus => 'Stav sítě';

  @override
  String get mosqueNoMore => 'Žádné další výsledky';

  @override
  String get mosqueNoResults => 'Žádné výsledky';
  ...
  @override
  String get afterAdhanHadithTitle => 'Po adhánu Du`aa';

  @override
  String get afterSalahHadith => 'Allahumma Rabba hadhihid-da\'wati-ttammati, was-salatil-qa\'imati, ati Muhammadanil-wasilata wal-fadhilata, wab\'athu maqaman mahmuda nilladhi wa \'adtahu [Ó Alláhu, Rubb této dokonalé výzvy (Da\'wah) a zavedené modlitby (As-Salat), uděl Muhammadovi Wasilu a převahu a pozvedni ho do chvályhodného postavení, které jsi mu slíbil].';
  ...
  @override
  String get turnOfPhones => 'Přepněte prosím své telefony do tichého režimu';

  @override
  String get iqamaIn => 'Iqama v';

  @override
  String get iqamaShowClock => 'Zobrazit hodiny na obrazovce ikámy';
  ...
  @override
  String get azkarList1 => 'Subḥānallāh, Alḥamdulillāh, Allāhu Akbar (33krát). Lā ilāha illallāhu waḥdahu lā sharīka lah, lahul-mulku wa lahul-ḥamd, wa huwa \'alā kulli shay\'in Qadīr';
  ...
  @override
  String get jumuaaHadith => 'Prorok ﷺ (mír a Alláhovo požehnání s ním) řekl: \"Kdo dokonale vykoná očistu, pak jde na džumuu a pak poslouchá a mlčí, tomu je odpuštěno to, co je mezi tímto časem a následujícím pátkem a dalšími třemi dny, a ten, kdo se dotýká kamenů, se jistě dopustil marnosti.\"';
  ...
  @override
  String get mosqueNotFoundMessage => 'Omlouváme se, ale vaše mešita nebyla nalezena, případně je nezvěstná nebo dočasně vypnutá.';

  @override
  String get noInternetMessage => 'Žádný přístup k internetu. Ověřte prosím své připojení k internetu a zkuste to znovu. Je vaše připojení Wi-Fi nebo Ethernet připojeno?';

  @override
  String get error => 'Chyba';

  @override
  String get mosqueErrorMessage => 'Chyba mešity Pokud jste správce mešity, kontaktujte naši podporu a vyřešte tento problém.';
  ...
  @override
  String get dhuAlhijjah => 'Dhu al-Hidždža';

  @override
  String get duaaBetweenSalahAndAdhan => 'Anas bin Malik řekl: Posel Alláhův ﷺ řekl: Mezi voláním k modlitbě a vstáváním k modlitbě se prosba nevrací.';

  @override
  String get salatKhayrMinaNawm => 'Assalatu khayrun mina nawm';

  @override
  String get salatElEid => 'Salát El Eid';

  @override
  String get webView => 'Povolení staršího režimu';

  @override
  String get developersHomeScreen => 'Domovská obrazovka vývojáře';

  @override
  String get onlineHome => 'Online Home';

  @override
  String get prayerTimes => 'Čas modlitby';

  @override
  String get alerts => 'Upozornění';

  @override
  String get iqamaaCountDown => 'Počet Iqamaa dolů';

  @override
  String get afterAdhanHadith => 'Po hadísu Adhán';

  @override
  String get afterSalahAzkar => 'Po Salahovi Azkarovi';

  @override
  String get iqama => 'Iqama';

  @override
  String get randomHadith => 'Náhodný hadís';

  @override
  String get announcement => 'Oznámení';

  @override
  String get jumuaaLive => 'Jumuaa [Přímý přenos]';

  @override
  String get showSecondaryScreen => 'Použití jako sekundární obrazovka (Pro oznámení)';

  @override
  String get normalScreen => 'Použití jako hlavní obrazovka';

  @override
  String get duaaRemainder => 'Duaa Zbytek';

  @override
  String get fajrWakeUp => 'Probuzení Fajr';

  @override
  String get changeLanguage => 'Změna jazyka';

  @override
  String get forceScreen => 'Obrazovka Force';

  @override
  String get clear => 'Přehledně';

  @override
  String get changeTheme => 'Změna tématu';

  @override
  String get next => 'Další';

  @override
  String get mainScreenOrSecondaryScreen => 'Umístění obrazovky';

  @override
  String get mainScreenOrSecondaryScreenEXPLINATION => 'Chcete tuto obrazovku instalovat do hlavní modlitebny (modlitebna pro muže) ?';

  @override
  String get mainScreen => 'Hlavní obrazovka';

  @override
  String get secondaryScreen => 'Sekundární obrazovka';

  @override
  String get duaaElEftar => 'Duaa El Eftar';

  @override
  String get announcementOnlyMode => 'Režim oznámení';

  @override
  String get normalMode => 'Normální režim ';
  ...
  @override
  String get duaaElEftarText => 'Žízeň byla uhašena, žíly zvlhčeny a odměna potvrzena, inšáAlláh';
  ...
  @override
  String get mainScreenExplanation => 'V případě hlavní místnosti mešity se na této obrazovce nezobrazuje přímý přenos jumuy.';

  @override
  String get normalModeExplanation => 'Zobrazí se normální obrazovka s časy modliteb a oznámeními.';
  ...
  @override
  String get applicationModes => 'Výchozí režim spuštění';
  ...
  @override
  String get ta_ar => 'Tamil a arabský';
  ...
  @override
  String get appTimezone => 'Časové pásmo aplikace';
  ...
  @override
  String get wifiForgetNetwork => 'Tato síť byla přidána v nastavení Androidu. Prosím zapomeňte ji tam, poté se znovu připojte.';
  ...
  @override
  String get deviceSettings => 'Zařízení';
  ...
  @override
  String get reciteType => 'Typ recitace';
  ...
  @override
  String get continueListening => 'Poslouchejte dál';
  ...
  @override
  String get surahSelector => 'Vyberte súru';
  ...
  @override
  String get rtspCameraSettingTitle => 'Živá kamera';
  ...
  @override
  String get holdOkToStop => 'Podržte OK pro zastavení';
  ...
  @override
  String get urlManagedByMosqueAdmin => 'URL spravována správcem mešity';
  ...
  @override
  String get streamMode => 'Režim streamu';

  @override
  String get streamModeDisabled => 'Deaktivováno';

  @override
  String get streamModeCamera => 'Stream závisí na kameře';

  @override
  String get streamModeJumuaOnly => 'Stream pouze pro Džumuu';

  @override
  String get streamModeJumuaAndPrayers => 'Stream podle Džumuy a 5 modliteb';

  @override
  String get streamRequiresSecondaryScreen => 'Tato funkce funguje pouze, když aplikace běží jako sekundární obrazovka. Pro aktivaci:';

  @override
  String get streamSecondaryScreenStep1 => 'Přejděte do zobrazení.';

  @override
  String get streamSecondaryScreenStep2 => 'Otevřete \"Výchozí režim spuštění\".';

  @override
  String get streamSecondaryScreenStep3 => 'Vyberte \"Sekundární obrazovka\".';

  @override
  String get rtspServerNotAvailable => 'RTSP server není dostupný. Zkontrolujte prosím své připojení.';
  ...
  @override
  String get testCrowdinCI => 'Testovací řetězec pro ověření CI workflow Crowdin na develop';

  @override
  String get quranMode => 'Režim Koránu';

  @override
  String get quranModeExplanation => 'Zobrazí se obrazovka s čtením Koránu, začínající na poslední čtené stránce';
  ...
  @override
  String get exitQuranModeTitle => 'Ukončit režim Koránu';

  @override
  String get exitQuranModeMessage => 'Chcete se vrátit do běžného režimu?';

  @override
  String get settingsSectionGlobal => 'Globální';

  @override
  String get hijriDateAdjustment => 'Úprava hidžrálního data';

  @override
  String get interfaceLanguage => 'Jazyk rozhraní';

  @override
  String get launchModeMainPrayer => 'Hlavní časy modliteb';

  @override
  String get launchModeSecondaryPrayer => 'Vedlejší časy modliteb';
  ...
  @override
  String get tutorialDontHaveId => 'Ještě nemáte ID mešity? Zde je postup:';

  @override
  String get tutorialStep1 => 'Přejděte na mawaqit.net a vytvořte si účet';

  @override
  String get tutorialStep2 => 'Zaregistrujte mešitu s fotografiemi a adresou';

  @override
  String get tutorialStep3 => 'Získejte své jedinečné ID mešity z panelu';

  @override
  String get tutorialStep4 => 'Zadejte zde ID pro připojení televizní obrazovky';
  ...
  @override
  String get tutorialScanToRegister => 'Naskenujte pro registraci';

  @override
  String get tutorialScanDescription => 'Použijte svůj telefon pro vytvoření účtu na mawaqit.net';

  @override
  String get tutorialFullTutorial => 'Celý tutoriál';
  ...
  @override
  String get athkarFontKufi => 'Kufí';

  @override
  String get athkarFontUthmani => 'Uthmánský';

  @override
  String get crowdinSyncCheck => 'Časy modliteb jsou zobrazeny pro vaši mešitu';
}
