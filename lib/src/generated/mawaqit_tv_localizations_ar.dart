...
class MawaqitTvLocalizationsAr extends MawaqitTvLocalizations {
  ...
  String get azkarList8 =>
      'أصبحنا وأصبح الملك لله، والحمد لله ولا إله إلا الله وحده لا شريك له، له الملك وله الحمد، وهو على كل شيء قدير، رب أسألك خير ما في هذا اليوم، وخير ما بعده، وأعوذ بك من شر ما في هذا اليوم، وشر ما بعده، وأعوذ بك من الكسل وسوء الكبر، وأعوذ بك من عذاب النار وعذاب القبر';

  @override
  String get azkarList9 =>
      'اللَّهُمَّ إِنِّي أَصْبَحْتُ أُشْهِدُكَ، وَأُشْهِدُ حَمَلَةَ عَرْشِكَ، وَمَلاَئِكَتِكَ، وَجَمِيعَ خَلْقِكَ، أَنَّكَ أَنْتَ اللَّهُ لَا إِلَهَ إِلاَّ أَنْتَ وَحْدَكَ لاَ شَرِيكَ لَكَ، وَأَنَّ مُحَمَّداً عَبْدُكَ وَرَسُولُكَ |أربعَ مَرَّات|.';
  ...
  String get azkarList12 =>
      'رَضِيتُ بِاللَّهِ رَبَّاً، وَبِالْإِسْلاَمِ دِيناً، وَبِمُحَمَّدٍ صلى الله عليه وسلم نَبِيّاً |ثلاثَ مرَّات|.ٍ';

  @override
  String get azkarList13 =>
      'لاَ إِلَهَ إِلاَّ اللَّهُ وَحْدَهُ لاَ شَرِيكَ لَهُ، لَهُ الْمُلْكُ وَلَهُ الْحَمْدُ، وَهُوَ عَلَى كُلِّ شَيْءٍ قَدِيرٌ |عشرَ مرَّاتٍ|.';

  @override
  String get azkarList14 =>
      'أمسينا و أمسى الملك لله، والحمد لله ولا إله إلا الله وحده لا شريك له، له الملك وله الحمد، وهو على كل شيء قدير، رب أسألك خير ما في هذا اليوم، وخير ما بعده، وأعوذ بك من شر ما في هذا اليوم، وشر ما بعده، وأعوذ بك من الكسل وسوء الكبر، وأعوذ بك من عذاب النار وعذاب القبر';
  ...
  @override
  String get duha => 'الضحى';

  @override
  String get duhaTime => 'وقت الضحى';
  ...
  String get noInternetMessage =>
      'لا يمكن الاتصال بالإنترنت. الرجاء التحقق من الاتصال بالإنترنت والمحاولة مرة أخرى. هل Wifi أو Ethernet متصل؟';
  ...
  String get duaaBetweenSalahAndAdhan =>
      'عن أنس بن مالك قال: قال رسول الله صلَّى اللهُ عليه وسلَّم: \"إنَّ الدعاءَ لا يُرَدُّ بيْن الأذانِ والإقامةِ؛ فادْعُوا\" رواه الترمذي';
  ...
  String get announcementOnlyModeEXPLINATION =>
      'اختر إذا كنت تود أن تعرض شاشة الإعلانات طوال الوقت، هذا يمكن أن يكون مفيداً إذا قمت بتثبيت الشاشة على سبيل المثال في المدخل.';
  ...
  String get secondaryScreenExplanation =>
      'غرفة الصلاة الثانوية (غرفة النساء أو طابق آخر على سبيل المثال)، ستظهر هذه الشاشة البث المباشر للجمعة إذا تم تفعيله على حساب MAWAQIT';
  ...
  String get takbeerAleidText =>
      'الله أكبر الله أكبر الله أكبر و لا إله إلا الله، الله أكبر الله أكبر الله أكبر و لله الحمد';
  ...
  String get hijriAdjustmentsDescription =>
      'قم بتعديل التاريخ الهجري محليًا على جهازك. هذا لن يؤثر على إعدادات المسجد عبر الإنترنت';
  ...
  String get rtspCameraSettingScreenDesc =>
      'إذا أدخلت رابطًا هنا، ستتحول شاشتك تلقائيًا إلى وضع بث الفيديو عند وصول وقت الجمعة.';
  ...
  String appUpdateAvailable(String currentVersion, String updatedVersion) {
    return 'تطبيقك يعمل بالإصدار $currentVersion. الإصدار الجديد $updatedVersion متوفر مع أحدث الميزات والتحسينات.';
  }
  ...
  @override
  String get holdOkToStop => 'اضغط مطولاً على موافق للإيقاف';
  ...
  String get replaceAppWorkflowWithCameraStream =>
      'سيعرض الشاشة بث الكاميرا تلقائيًا بمجرد أن تبدأ الكاميرا في التسجيل، وإذا توقفت يعود العرض إلى مواقيت الصلاة';
