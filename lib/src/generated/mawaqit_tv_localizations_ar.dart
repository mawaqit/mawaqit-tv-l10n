...
class MawaqitTvLocalizationsAr extends MawaqitTvLocalizations {
  ...
  @override
  String get azkarList14 => 'أمسينا وأمسى الملك لله، والحمد لله، لا إله إلا الله وحده لا شريك له، له الملك وله الحمد وهو على كل شيء قدير، ربِّ أسألك خير ما في هذه الليلة وخير ما بعدها، وأعوذ بك من شر ما في هذه الليلة وشر ما بعدها، رب أعوذ بك من الكسل، وسُوءِ الكِبَرِ، رب أعوذ بك من عذاب في النار، وعذاب في القبر';
  ...
  @override
  String get prayerTimeFontSize => 'حجم النص والعرض';

  @override
  String get prayerTimeFontSizeDesc => 'غيّر حجم النص الظاهر في جميع أنحاء التطبيق';
