...
class MawaqitTvLocalizationsDa extends MawaqitTvLocalizations {
  ...
  String get hadithLangDesc =>
      'Dette tilsidesætter dit valg i admin-konsollen, kan du vælge et andet sprog ved skærmen';
  ...
  String get jumuaaHadith =>
      'Profeten ﷺ (Allahs fred og velsignelser være med ham) sagde: \"Den, der gør afvaskningerne perfekt og derefter går til jumua og derefter lytter og er tavs, han er tilgivet, hvad der er mellem det tidspunkt og den følgende fredag og tre dage mere, og den, der rører ved sten, har helt sikkert gjort en meningsløshed\"';
  ...
  String get mosqueNotFoundMessage =>
      'Beklager, din moské blev ikke fundet, eller den mangler måske eller er midlertidigt deaktiveret.';

  @override
  String get noInternetMessage =>
      'Ingen internetadgang. Kontroller venligst din internetforbindelse og prøv igen. Er din Wi-Fi- eller Ethernet-forbindelse tilsluttet?';
  ...
  String get mosqueErrorMessage =>
      'Fejl i moské, hvis du er moskéadministrator, kontakt vores support for at løse dette problem';
  ...
  String get duaaBetweenSalahAndAdhan =>
      'Anas bin Malik sagde: Allahs Sendebud ﷺ sagde: Allahs bønner: \"Bønnen vender ikke tilbage mellem kald til bøn og bønnen.';
  ...
  String get mainScreenOrSecondaryScreenEXPLINATION =>
      'Ønsker du at installere denne skærm i det primære bederum (mændenes bederum) ?';
  ...
  String get announcementOnlyModeEXPLINATION =>
      'Vælg, om din skærm skal vise meddelelser hele tiden, hvilket kan være nyttigt, hvis du f.eks. installerer skærmen ved indgangen.';
  ...
  String get secondaryScreenExplanation =>
      'For et sekundært bederum (f.eks. et kvinderum eller en anden etage) vil denne skærm vise jumua live-streaming';
  ...
  String get deviceDefaultBTNDescription =>
      'Mawaqit vil automatisk vælge standardretningen baseret på skærmens orientering';
  ...
  String get landscapeBTNDescription =>
      'For horisontal orientering. Det vigtigste layout for mawaqit tv app og anbefalede en for de fleste moskeer';
  ...
  String get ifYouAreFacingAnIssueWithTheAppActivateThis =>
      'Hvis du støder på et problem med appen, skal du aktivere denne mulighed';
  ...
  String get hijriAdjustmentsDescription =>
      'Juster hijri-datoen lokalt på din enhed. Dette vil ikke påvirke onlinemoskeindstillingerne';
  ...
  String get automaticUpdateDescription =>
      'Aktiver notifikationsopdatering for at modtage de nyeste funktioner og forbedringer';

  @override
  String get checkInternetLegacyMode =>
      'Du skal oprette forbindelse til internettet for at bruge den tidligere tilstand';
  ...
  String get rtspCameraSettingScreenDesc =>
      'Hvis du indtaster en URL her, vil din skærm automatisk skifte til videostreaming når Jumua tid ankommer';
  ...
  String get replaceAppWorkflowWithCameraStream =>
      'Skærmen vil automatisk vise kameraet, så snart kameraet begynder at optage hvis det stopper, skærmen vender tilbage til bønnen gange display';
